...
export default function Brief() {
  ...
  return (
    <div className="brief">
      ...
      <div className="brief-figures stagger">
      ...
      <div className="brief-foot">
        <button className="pri" onClick={() => navigate("dashboard")} disabled={navBusy}>
          {navBusy ? "Loading…" : "Open the terminal"} <IconArrowRight size={14} />
        </button>
        <p className="note">
